...
public partial class SupportingCharactersPage : ContentPage
{
    public SupportingCharactersPage()
    {
        InitializeComponent();
        LoadCharacters();
    }
    ...
    {
        CharactersCollectionView.ItemsSource = CharacterService.GetSupportingCharacters();
    }
